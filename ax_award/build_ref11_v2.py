...
SOURCE = Path(r"D:\project\q-agent\ax_award\html\AX_Award_지원서_ref11_v1.html")
...
.micro { color: #4b5b73; font-size: 13.33px; line-height: 1.35; }
.strong { color: #0f1e3d; font-weight: 700; }
.teal { color: #0e9c97; }
.pill { display: inline-block; padding: 2px 7px; border-radius: 3px; background: #0f1e3d; color: #fff; font-size: 13.33px; line-height: 1.25; font-weight: 700; }
.rule { height: 1px; margin: 8px 0; background: #d7deea; }
.page-no { position: absolute; right: 0; bottom: 40px; left: 0; color: #718096; font-size: 13.33px; text-align: center; }
.page svg text { font-size: 13.33px !important; }

/* P1 */
.ribbon { display: grid; grid-template-columns: repeat(10, 1fr); margin: 7px 0 5px; overflow: hidden; border-radius: 4px; }
.ribbon span { min-height: 43px; padding: 5px 2px 3px; background: #e9edf3; color: #4b5b73; font-size: 13.33px; line-height: 1.15; text-align: center; border-right: 2px solid #fff; }
.ribbon span:nth-child(n+3):nth-child(-n+8) { background: #0f1e3d; color: #fff; }
.ribbon span:nth-child(8) { background: #12b5b0; }
.ribbon-note { display: flex; justify-content: space-between; margin-bottom: 5px; color: #4b5b73; font-size: 13.33px; }
...
.time-axis .times { position: absolute; top: 4px; right: 7px; left: 7px; display: flex; justify-content: space-between; color: #0f1e3d; font-size: 13.33px; font-weight: 700; }
.time-axis .segments { display: grid; grid-template-columns: 45fr 12fr 31fr 12fr; color: #fff; font-size: 13.33px; font-weight: 700; text-align: center; }
...
.arch-sub { margin:2px 0 9px; color:#4b5b73; font-size:13.33px; }
.arch-flow { display:grid; grid-template-columns:1fr 22px 1.25fr 22px 1fr 22px 1fr 22px 1fr; align-items:stretch; }
.arch-node { min-height:82px; padding:6px 5px; border-top:4px solid #0f1e3d; background:#fff; color:#33415e; font-size:13.33px; line-height:1.22; text-align:center; box-shadow:0 0 0 1px #cbd4e0 inset; }
...
.arch-return { position:absolute; right:20px; bottom:6px; left:20px; color:#0e9c97; font-size:13.33px; font-weight:700; text-align:center; border-top:2px dashed #12b5b0; }
...
/* P4 */
.p4 .content { padding-top: 6px !important; padding-bottom: 6px !important; }
.p4 .content > .section-title { margin-bottom: 3px; }
.p4 .ablation { margin-top: 3px; margin-bottom: 5px; }
.p4 .rag { margin-top: 3px; margin-bottom: 5px; }
...
.verify > div { min-height:78px; padding:6px 7px; border:1px solid #cbd4e0; border-top:4px solid #0f1e3d; color:#33415e; font-size:13.33px; line-height:1.25; }
...
.assumption { margin-top:4px; color:#4b5b73; font-size:13.33px; line-height:1.35; text-align:left; }
...
<div class="arch"><div class="arch-title">품질 AI Agent Architecture</div><div class="arch-sub">입구부터 등록까지 조사 코어와 승인 흐름을 공유한다.</div><div class="arch-flow"><div class="arch-node"><b class="strong">① 입구</b><br>SPC<br>Chat</div><div class="arch-arrow">→</div><div class="arch-node core"><b class="strong">② Router</b><br>도구 선택<br>가설 갱신</div><div class="arch-arrow">→</div><div class="arch-node"><b class="strong">③ 판정</b><br>근거 조합<br>검증 5칙</div><div class="arch-arrow">→</div><div class="arch-node"><b class="strong">④ 조치</b><br>L1~L5<br>L4 승인</div><div class="arch-arrow">→</div><div class="arch-node"><b class="strong">⑤ 등록</b><br>승인 이력<br>재사용</div></div><div class="arch-return">확정 이력을 조사 규칙, 검색 코퍼스, 평가셋에 반영</div></div>
...
<div class="verify"><div class="qmetric"><b class="strong">Q-Agent [실측]</b><br><span style="font-size:18px;font-weight:700;color:#0f1e3d">recall@10 0.500</span><br>골든 4 / 색인 50</div><div><b class="strong">검색 B [선행 실측]</b><br>hit@1 1.000<br>hard 0.957</div><div><b class="strong">이미지 A [선행 실측]</b><br>noise 0.52%<br>AMI .956 / ARI .860<br>43 class / 900 wafer</div><div><b class="strong">안전 gate [목표]</b><br>근거 없음 0<br>미승인 L4 0<br>접수 누락 0</div></div>
""")
