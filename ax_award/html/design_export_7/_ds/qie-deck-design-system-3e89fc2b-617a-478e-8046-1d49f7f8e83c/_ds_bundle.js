/* @ds-bundle: {"format":3,"namespace":"QIEDeckDesignSystem_3e89fc","components":[{"name":"BeforeAfter","sourcePath":"components/core/BeforeAfter.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Chip","sourcePath":"components/core/Chip.jsx"},{"name":"DataTable","sourcePath":"components/core/DataTable.jsx"},{"name":"FlowBox","sourcePath":"components/core/FlowBox.jsx"},{"name":"Panel","sourcePath":"components/core/Panel.jsx"},{"name":"ProgressRail","sourcePath":"components/core/ProgressRail.jsx"},{"name":"StatCard","sourcePath":"components/core/StatCard.jsx"},{"name":"Timeline","sourcePath":"components/core/Timeline.jsx"},{"name":"TitleBlock","sourcePath":"components/core/TitleBlock.jsx"}],"sourceHashes":{"components/core/BeforeAfter.jsx":"79af99709684","components/core/Button.jsx":"2c0108cb86ff","components/core/Chip.jsx":"169f7b92e02a","components/core/DataTable.jsx":"6fd1c02677a8","components/core/FlowBox.jsx":"0157fe172a6a","components/core/Panel.jsx":"f28819b7c9d5","components/core/ProgressRail.jsx":"5520d35ef6ab","components/core/StatCard.jsx":"a677eca79e4d","components/core/Timeline.jsx":"3b97075698d3","components/core/TitleBlock.jsx":"85b4334f59df","ui_kits/deck/deck-stage.js":"e529c4de2f18"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.QIEDeckDesignSystem_3e89fc = window.QIEDeckDesignSystem_3e89fc || {});
...
/**
 * BeforeAfter — the "적용 전 → 후" comparison row. A muted panel ("before"),
 * a teal arrow, and a teal-tint panel ("after") with a left teal bar.
 */
function BeforeAfter({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      ...
      borderLeft: "var(--bar-w) solid var(--accent)"
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--fw-bold) 11px/1 var(--font-sans)",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Button — interactive primitive in the brand palette. Variants: "primary"
 * (teal fill), "navy" (navy fill), "outline" (navy text + hairline), "ghost"
 * (teal text only). Flat at rest; the one allowed hover lift on press.
 */
function Button({
  children,
  variant = "primary",
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    style: {
      ...
      borderRadius: "var(--radius-sm)",
      padding: s.pad,
      font: "var(--fw-bold) " + s.fs + "/1 var(--font-sans)",
      transition: "background var(--dur) var(--ease), box-shadow var(--dur) var(--ease)",
      boxShadow: hover && !disabled && variant !== "ghost" ? "var(--elev-hover)" : "none",
      ...style
    }
  }, rest), children);
}
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Chip — compact rounded label / tag. Three tones map to the deck's usage:
 * "teal" (active / accent), "navy" (neutral strong), "panel" (muted on white),
 * plus "tealSoft" for the teal-tint highlight. Used for tags inside flow boxes,
 * status pills, and mini labels.
 */
function Chip({
  children,
  tone = "teal",
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DataTable — navy header row, zebra body (white / panel), optional teal-tint
 * highlight row. Flat, hairline-free interior with a clean header band; the
 * deck's standard comparison table.
 */
function DataTable({
  headers,
  rows,
  ...
  const colAlign = j => align && align[j] || (j === 0 ? "left" : "center");
  return /*#__PURE__*/React.createElement("table", _extends({
    style: {
      width: "100%",
      borderCollapse: "separate",
      borderSpacing: 0,
      font: "var(--fw-regular) var(--fs-body-sm)/1.35 var(--font-sans)",
      ...style
    }
  }, rest), /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, headers.map((h, j) => /*#__PURE__*/React.createElement("th", {
    key: j,
    style: {
      background: "var(--navy)",
      color: "#fff",
      font: "var(--fw-bold) var(--fs-label)/1.25 var(--font-sans)",
      textAlign: colAlign(j),
      padding: "12px 14px",
      whiteSpace: "pre-line"
    }
  }, h)))), /*#__PURE__*/React.createElement("tbody", null, rows.map((row, i) => {
    const hl = highlightRow === i;
    const bg = hl ? "var(--teal-tint)" : i % 2 === 0 ? "var(--white)" : "var(--panel)";
    return /*#__PURE__*/React.createElement("tr", {
      ...
      style: {
        background: bg,
        color: hl ? "var(--navy)" : "var(--ink)",
        fontWeight: hl ? "var(--fw-bold)" : "var(--fw-regular)",
        textAlign: colAlign(j),
        padding: "11px 14px",
        whiteSpace: "pre-line"
      }
...
// components/core/FlowBox.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * FlowBox — a rounded node for pipeline / architecture diagrams. Title, an
 * optional sub line, and optional tags. Tone sets the fill: "navy" (default
 * stage), "navy2" (nested sub-stage), "teal" (the highlighted / owned step),
 * "panel" (light). Text contrast and tag colour adapt automatically.
 */
function FlowBox({
  title,
  sub,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      font: "var(--fw-bold) 14px/1.25 var(--font-sans)"
    }
  ...
  }, sub), tagList.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      font: "var(--fw-bold) 10.5px/1.3 var(--font-sans)",
      color: t.tag,
      marginTop: "2px"
    }
  }, tagList.join("   ")));
}
Object.assign(__ds_scope, { FlowBox });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/FlowBox.jsx", error: String((e && e.message) || e) }); }

// components/core/Panel.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Panel — generic flat surface. Optional accent strip on the top or left edge,
 * optional hairline border, optional dark/teal fill. The building block behind
 * stat cards, two-column bodies and sidebars. Flat by design (no shadow).
 */
function Panel({
  children,
  tone = "panel",
  // "panel" | "white" | "navy" | "teal-tint"
  accent,
  // "top" | "left" | undefined
  ...
  const f = fills[tone] || fills.panel;
  return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      position: "relative",
      background: f.bg,
  ...
  }, rest), accent === "top" && /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      position: "absolute",
      insetInline: 0,
  ...
  }), accent === "left" && /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      position: "absolute",
      insetBlock: 0,
...
// components/core/ProgressRail.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * ProgressRail — the P1·P2·P3 vertical progress indicator used on section
 * dividers. Each item is a dot + label; the active one gets a teal dot and
 * navy bold label, the rest a grey dot and muted label.
 */
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        background: on ? "var(--accent)" : "var(--dot-off)",
        flex: "0 0 auto"
      }
    }), /*#__PURE__*/React.createElement("span", {
      style: {
        font: (on ? "var(--fw-bold)" : "var(--fw-regular)") + " var(--fs-label)/1.2 var(--font-sans)",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/ProgressRail.jsx", error: String((e && e.message) || e) }); }

// components/core/StatCard.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * StatCard — flat panel with a teal top strip, a big navy numeral, and a label.
 * The hero metric motif used across section, stats, two-column and closing
 * slides. Set `tone="gold"` ONLY for a final business-value KPI.
 */
function StatCard({
  big,
  label,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      position: "relative",
      background: isGold ? "var(--teal-tint)" : "var(--surface-card)",
      borderRadius: "var(--radius-md)",
      overflow: "hidden",
    ...
    style: {
      font: "var(--fw-bold) var(--fs-stat-sm)/1.1 var(--font-sans)",
      color: isGold ? "var(--navy)" : "var(--navy)",
      letterSpacing: "var(--ls-tight)"
    }
  }, big), label && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "6px",
      font: "var(--fw-bold) var(--fs-label)/1.3 var(--font-sans)",
      color: "var(--text-body)"
    }
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * Timeline — horizontal roadmap axis with milestone nodes alternating above /
 * below the line. Completed milestones are filled teal circles; upcoming ones
 * are teal-outlined hollow circles. A faint teal stem links node to label.
 */
function Timeline({
  items,
  style,
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, above && /*#__PURE__*/React.createElement(Label, {
      it: it,
      align: "above"
    }), /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true",
      style: {
        position: "absolute",
        top: above ? "calc(50% - 56px)" : "calc(50% + 16px)",
        width: "2px",
        height: "40px",
        background: "var(--teal-stem)"
      }
    }), /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true",
      style: {
        ...
        height: "16px",
        borderRadius: "var(--radius-pill)",
        background: it.done ? "var(--accent)" : "var(--white)",
        border: it.done ? "none" : "2.5px solid var(--accent)",
        zIndex: 1
      }
    }), !above && /*#__PURE__*/React.createElement(Label, {
      it: it,
...
function Label({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      top: align === "above" ? 0 : "calc(50% + 60px)",
      bottom: align === "above" ? "calc(50% + 60px)" : "auto",
      display: "flex",
      flexDirection: "column",
      justifyContent: align === "above" ? "flex-end" : "flex-start",
      alignItems: "center",
      textAlign: "center",
      gap: "2px",
      width: "150px",
    ...
    style: {
      ...
      color: it.done ? "var(--accent)" : "var(--muted)"
    }
  }, it.date), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--fw-bold) 12px/1.25 var(--font-sans)",
      color: "var(--navy)"
    }
  }, it.label), it.sub && /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--fw-regular) 10.5px/1.25 var(--font-sans)",
      color: "var(--muted)"
    }
  }, it.sub));
}
...
// components/core/TitleBlock.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * TitleBlock — the signature slide header: a teal vertical accent bar, an
 * optional teal kicker (eyebrow), the navy title, and an optional subtitle.
 * Titles are NEVER underlined in this system; the left bar carries the accent.
 */
function TitleBlock({
  kicker,
  title,
  subtitle,
  size = "heading",
  // "heading" (content slide, 27px) | "title" (section/closing, 32px)
  style,
  ...rest
}) {
  const titleSize = size === "title" ? "var(--fs-title)" : "var(--fs-heading)";
  const barH = size === "title" ? 78 : 62;
  return /*#__PURE__*/React.createElement("div", _extends({
    style: {
      display: "flex",
      gap: "16px",
    ...
    style: {
      font: "var(--fw-bold) " + titleSize + "/var(--lh-heading) var(--font-sans)",
    ...
    style: {
      font: "var(--fw-regular) var(--fs-lead)/var(--lh-body) var(--font-sans)",
      color: "var(--text-subtitle)"
    }
  }, subtitle)));
}
Object.assign(__ds_scope, { TitleBlock });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/TitleBlock.jsx", error: String((e && e.message) || e) }); }
...
__ds_ns.FlowBox = __ds_scope.FlowBox;
